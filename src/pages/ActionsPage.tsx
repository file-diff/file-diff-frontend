...
const ACTIONS_API_ROUTE = "POST /api/jobs/actions";
...
const ACTIONS_DELETE_UNSUPPORTED_NOTICE = `${ACTIONS_DELETE_UNSUPPORTED_NOTICE_PREFIX}${ACTIONS_API_ROUTE}${ACTIONS_DELETE_UNSUPPORTED_NOTICE_SUFFIX}`;
